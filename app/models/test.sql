SELECT mg01.*, mg02.mk01_id, mg02.mg01_id, mg02.nilgj, 
                ...
                THEN 
                        period_diff(date_format(DATE_ADD('2016-08-31 00:00:00', INTERVAL 1 MONTH), '%Y%m'), date_format('2016-08-31 00:00:00', '%Y%m'))
                ELSE 
                        ...
                        THEN 
                                ...
                                FROM ( 
                                    ...
                                    FROM ta02 as tabel_luar 
                                        WHERE MONTH(tabel_luar.tglmsk) = MONTH('2016-08-31 00:00:00') AND YEAR(tabel_luar.tglmsk) = YEAR('2016-08-31 00:00:00')
                                    ) as tabel_terluar
                ...
                CASE WHEN mg01.jntgh = 'Hari' THEN
                    (SELECT COUNT(*) FROM ta02 WHERE ta02.abscd = 0 AND ta02.mk01_id = karyawan.idkar AND MONTH(ta02.tglmsk) = MONTH('2016-08-31 00:00:00'))
                        ELSE
