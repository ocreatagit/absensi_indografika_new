                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="text-center">                            
                                    <a href="{{ url("uploads/".$karyawan->pic) }}" data-lightbox="roadtrip"> {{ $karyawan->pic != "" ? HTML::image('uploads/'.$karyawan->pic, $karyawan->nama, array('class' => 'thumbnail', "width" => 200, "height" => 200)) : HTML::image('uploads/no_image.png', "No Image", array('class' => 'thumbnail', "width" => 180)) }} </a> 
                                </div>
                                <div class="text-left">
                                ...
                                <div class="text-center">
                                    <?php if ($karyawan->jnsusr == 0) {
                                        ?>
                                        <a href="{{ action('MasterKaryawanController@edit', $karyawan->idkar) }}" class="btn btn-info disabled" data-toggle="tooltip" data-placement="left" title="Edit Data?"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <?php
                                    } else {
                                        ?>
                                    ...
                                    <?php }
                                    ?>
                                    <a href="#" class="btn btn-info" data-toggle="modal" data-placement="center" title="User Matrix?" data-target="#myModal" onclick="UserMatrixModal(<?php echo $karyawan->idkar ?>,'{{ $karyawan->nama }}')"><i class="fa fa-user"></i></a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <form id="formUM" action="<?php echo action("MasterKaryawanController@usermatrixsave") ?>" method="POST" class="form-horizontal">
                        <div class="form-group">        
                            ...
                            <div class="checkbox col-md-4">
                                <label><input type="checkbox" class="jsUM" id="matrix{{ $um->idmnu }}" name="matrix{{ $um->idmnu }}" value="{{ $um->idmnu }}" >{{ $um->nama }}</label>
                            </div>
                            @endforeach
                        </div>
                        <div class="form-group">
