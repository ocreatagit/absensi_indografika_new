...
<div class="row"><div class="col-sm-12" style="">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h3 class="page-header"><i class="fa fa-info-circle"></i> Master Jenis Gaji</h3>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="col-sm-8 input-group">
                            ...
                            <a href="{{ action('MasterGajiController@index') }}" class="btn btn-default siku"><i class="fa fa-repeat"></i> Reset</a>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    <tbody class="text-left">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ action('MasterGajiController@edit', $gaji->idgj) }}" class="btn btn-info siku" data-toggle="tooltip" data-placement="left" title="Edit Data?"><i class="fa fa-edit"></i></a>
                                <a href="{{ action('MasterGajiController@destroy', $gaji->idgj) }}" class="btn btn-danger siku delete" data-toggle="tooltip" data-placement="right" title="Hapus Data?"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
        <!--                <tr>
