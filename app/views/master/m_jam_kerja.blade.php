    ...
    <div class="col-sm-12" style="">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h3 class="page-header"><i class="fa fa-info-circle"></i> Master Jam Kerja</h3>
            </div>
            <form class="form-horizontal" action="{{ $action }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="col-sm-6 input-group clockpicker">
                            <input type="text" class="form-control siku" value="{{ Input::old('jmmsk', $jam_kerja["jmmsk"]) }}" name="jmmsk">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="col-sm-6 input-group clockpicker">
                            <input type="text" class="form-control siku" value="{{ Input::old('jmklr', $jam_kerja["jmklr"]) }}" name="jmklr">
                            <span class="input-group-addon siku">
                                <span class="glyphicon glyphicon-time"></span>
                            </span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="col-sm-8 input-group">
                            ...
                            <a href="{{ action('MasterJamKerjaController@index') }}" class="btn btn-default siku"><i class="fa fa-repeat"></i> Reset</a>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                                ...
                                <tbody class="text-left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ action('MasterJamKerjaController@edit', $jam_kerja->idjk) }}" class="btn btn-info siku" data-toggle="tooltip" data-placement="left" title="Edit Data?"><i class="fa fa-edit"></i></a>
                                            <?php
                                            if ($jam_kerja->status == 'N') {
                                                ?>
                                                <a href="{{ action('MasterJamKerjaController@active', $jam_kerja->idjk) }}" class="btn btn-success siku" data-toggle="tooltip" data-placement="right" title="Aktifkan Data?"><i class="fa fa-check"></i></a>
                                                <?php
                                            } else {
                                                ?>
                                                <a href="{{ action('MasterJamKerjaController@destroy', $jam_kerja->idjk) }}" class="btn btn-danger siku delete" data-toggle="tooltip" data-placement="right" title="NonAktifkan Data?"><i class="fa fa-times"></i></a>
                                                <?php }
                                                ?>
                                        </td>
                                    </tr>
