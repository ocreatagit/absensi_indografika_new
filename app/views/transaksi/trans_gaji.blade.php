    ...
    <div class="col-sm-12" style="">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h3 class="page-header"><i class="fa fa-info-circle"></i> Input Slip Gaji</h3>
                <a id="tambah" href="{{ action('TransaksiGajiController@show') }}" class="btn btn-primary siku"><i class="fa fa-plus-square"></i> Pembayaran Gaji Karyawan</a>
            </div>
            <div class="panel-body">
                <div class="col-sm-12">
                        ...
                        <tbody class="text-left">
                            ...
                            <tr>
                                ...
                                <td class="text-center" width="15%">
                                    <a href="{{ action('TransaksiGajiController@destroy', [$gaji->idtg]) }}" class="btn btn-danger siku" data-toggle="tooltip" data-placement="left" title="Hapus Transaksi?"><i class="fa fa-times"></i></a>
                                        <?php $no++; ?>
                                </td>
                            </tr>
                            @endforeach
