    ...
    <div class="col-sm-12" style="">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h3 class="page-header"><i class="fa fa-info-circle"></i> Input Data Alpha / Cuti </h3>
            </div>
            <div class="panel-body">
                <div class="col-sm-12">
                    <div>
                        ...
                        <tbody class="text-left">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ action('TransaksiAlphaController@destroy', [$alpha->id]) }}" class="btn btn-danger siku delete" data-toggle="tooltip" data-placement="right" title="Hapus Data?"><i class="fa fa-trash"></i></a>
                                </td>                                
                            </tr>
                            <?php $no++; ?>
                            @endforeach
