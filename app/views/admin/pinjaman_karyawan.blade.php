    ...
    <div class="col-sm-12" style="">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                @endif
                <form class="form-horizontal" action="{{ action("LaporanAdminController@histori_hutang_query") }}" method="POST">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($allHutang->jenhut == "Hutang") {
                                    ?>
                                    <a href="{{ action('LaporanAdminController@show_pinjaman', [$allHutang->idhut]) }}" class="btn btn-info siku" data-toggle="tooltip" data-placement="left" title="Detail?"><i class="fa fa-info-circle"></i></a> 
                                    <?php
                                } else {
                                    ?>
