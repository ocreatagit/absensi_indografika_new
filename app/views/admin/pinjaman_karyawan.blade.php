                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($allHutang->jenhut == "Hutang") {
                                ?>
                                <a href="{{ action('LaporanAdminController@show_pinjaman', [$allHutang->idhut]) }}" class="btn btn-info" data-toggle="tooltip" data-placement="left" title="Detail?"><i class="fa fa-info-circle"></i></a> 
                                <?php
                            } else {
                                ?>
