                ...
                <table class="table table-bordered table-hover" id="datatable">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ action('LaporanAdminController@show_tabungan', [$allTabungan->idkar]) }}" class="btn btn-info siku" data-toggle="tooltip" data-placement="right" title="Detail?"><i class="fa fa-info-circle"></i></a> 
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
