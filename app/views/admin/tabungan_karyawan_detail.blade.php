    ...
    <div class="col-sm-12" style="">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a href="{{ url("admin/alltabungankaryawan") }}" class="btn btn-primary siku"><i class="fa fa-backward"></i> Kembali</a>
            </div>
            <div class="panel-body"> 
                <div class="col-sm-3 padleft6percent" style="margin-bottom: 10px;">
                    <a href="{{ url("uploads/".$karyawan->pic) }}" data-lightbox="roadtrip"> {{ $karyawan->pic != "" ? HTML::image('uploads/'.$karyawan->pic, $karyawan->nama, array('class' => 'thumbnail siku', "width" => 150)) : HTML::image('uploads/no_image.png', "No Image", array('class' => 'thumbnail siku', "width" => 150)) }} </a>
                ...
                <div class="col-sm-9" style="padding-left: 35px;">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            @endif
                            <form class="form-horizontal" action="{{ action("LaporanAdminController@histori_tabungan_query") }}" method="POST">
